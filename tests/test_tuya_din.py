...
class TestTuyaManufClusterDinPower:
    ...
    def test_update_total_energy(self, tuya_power_meter):
        ...
        tuya_power_meter.endpoint.smartenergy_metering.energy_deliver_reported.assert_called_once_with(100)
    ...
    def test_update_current(self, tuya_power_meter):
        ...
        tuya_power_meter.endpoint.electrical_measurement.current_reported.assert_called_once_with(1000)
    ...
    def test_update_power(self, tuya_power_meter):
        ...
        tuya_power_meter.endpoint.electrical_measurement.power_reported.assert_called_once_with(200)
    ...
    def test_update_voltage(self, tuya_power_meter):
        ...
        tuya_power_meter.endpoint.electrical_measurement.voltage_reported.assert_called_once_with(230)
...
class TestHikingManufClusterDinPower:
    ...
    def test_update_switch(self, hiking_power_meter):
        ...
        hiking_power_meter.endpoint.device.switch_bus.listener_event.assert_called_once_with("switch_event", 16, 1)
    ...
    def test_update_energy_delivered(self, hiking_power_meter):
        ...
        hiking_power_meter.endpoint.smartenergy_metering.energy_deliver_reported.assert_called_once_with(100)
    ...
    def test_update_voltage_current(self, hiking_power_meter):
        ...
        hiking_power_meter.endpoint.electrical_measurement.current_reported.assert_called_once_with(1000)
        hiking_power_meter.endpoint.electrical_measurement.voltage_reported.assert_called_once_with(230)
...
class TestZemismartPowerMeasurement:
    ...
    def test_vcp_reported_phase_a(self, zemismart_power_meter):
        ...
        zemismart_power_meter.endpoint.device.clamp_bus["power"]["a"].listener_event.assert_any_call(
            "power_reported", 100
        )
        zemismart_power_meter.endpoint.device.clamp_bus["power"]["a"].listener_event.assert_any_call(
    ...
    def test_invalid_phase(self, zemismart_power_meter):
        ...
        with pytest.raises(ValueError):
            zemismart_power_meter.endpoint.electrical_measurement.vcp_reported(test_data, 3)
